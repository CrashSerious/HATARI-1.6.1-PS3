...
//hack ps3
 strcpy( psWorkingDir,"/dev_hdd0/HOMEBREW/ST");
 strcpy( psHomeDir,"/dev_hdd0/HOMEBREW/ST/CONF");
//fin hack ps3
...
//hack ps3 
sprintf(ConfigureParams.Rom.szTosImageFileName, "%srom", "/dev_hdd0/HOMEBREW/ST/TOS/");
//fin hack ps3
